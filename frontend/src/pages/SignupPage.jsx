    ...
    <div className="min-h-screen bg-[#0B0E11] flex items-center justify-center p-4">
      <div className="w-full max-w-md bg-[#12171E] border border-slate-800/80 rounded-2xl p-8 shadow-2xl">
        <div className="text-center mb-8">
          ...
          <h1 className="text-xl font-bold tracking-tight text-slate-100 font-mono">Join SIGNAL</h1>
          <p className="text-xs text-slate-400 mt-1">Configure your memory-enabled market watchlist.</p>
        </div>
